...
When('Escenario23 Doy click en save', async function() {
    ...
    await body.saveScreenshot('reports/Ghost_' + json.VersionEnPrueba + '_Escenario23_crear_member_save(1).png');
...
Then("Escenario23 Debe aparecer el Member en la lista y lo selecciono", async function () {
    ...
    let body = await this.driver.$('/html/body');
    await body.saveScreenshot('reports/Ghost_' + json.VersionEnPrueba + '_Escenario23_crear_member(1).png');
...
When('Escenario23 Doy click en Confirm Delete Member', async function() {
    ...
    await body.saveScreenshot('reports/Ghost_' + json.VersionEnPrueba + '_Escenario23_delete_member(1).png');
...
if(json.VersionEnPrueba==2){
    ...
    When('Escenario23 Doy click en save', async function() {
        ...
        let body = await this.driver.$('/html/body');
        await body.saveScreenshot('reports/Ghost_' + json.VersionEnPrueba + '_Escenario23_crear_member_save(2).png');
    ...
    Then("Escenario23 Debe aparecer el Member en la lista y lo selecciono", async function () {
        ...
        await elementoEliminar.click();  
        let body = await this.driver.$('/html/body');
        await body.saveScreenshot('reports/Ghost_' + json.VersionEnPrueba + '_Escenario23_crear_member(2).png');
    ...
    When('Escenario23 Doy click en Confirm Delete Member', async function() {
        ...
        await body.saveScreenshot('reports/Ghost_' + json.VersionEnPrueba + '_Escenario23_delete_member(2).png');
