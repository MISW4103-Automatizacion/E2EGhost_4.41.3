...
if (json.isRegresionVisual) {
    mail = mail = 'pruebaRegresion@regresion.com.co';
} else {
...
When('Doy click en el radio boton Contributor', async function () {
    if(json.VersionEnPrueba == 1) {
        ...
        let element = await this.driver.$('/html/body/div[4]/div/div/div/div/div[2]/section/div[1]/fieldset/div[2]/div[1]');
        return await element.click();
    }
...
When('Doy click en el radio boton Autor', async function () {
    if(json.VersionEnPrueba == 1) {
        ...
        let element = await this.driver.$('/html/body/div[4]/div/div/div/div/div[2]/section/div[1]/fieldset/div[2]/div[2]');
        return await element.click();
    }
...
When('Doy click en el radio boton Editor', async function () {
    if(json.VersionEnPrueba == 1) {
        ...
        let element = await this.driver.$('/html/body/div[4]/div/div/div/div/div[2]/section/div[1]/fieldset/div[2]/div[3]');
        return await element.click();
    }
...
When('Doy click en el radio boton Administrador', async function () {
    if(json.VersionEnPrueba == 1) {
        ...
        let element = await this.driver.$('/html/body/div[4]/div/div/div/div/div[2]/section/div[1]/fieldset/div[2]/div[4]');
        return await element.click();
    }
...
When('Doy click en el boton Send invitation now', async function () {
    if(json.VersionEnPrueba == 1) {
        ...
        let element = await this.driver.$('/html/body/div[4]/div/div/div/div/div[2]/section/div[2]/button');
        return await element.click();
    }
...
When('Eliminar un staff creado previamente {string}', async function (Esperado) {
    ...
    if(json.VersionEnPrueba == 1) {
        ...
        let elementoEliminar = await this.driver.$('/html/body/div[2]/div/main/section/section/section[1]/div/div/article/div[2]/div/a[1]');
        await elementoEliminar.click();
        resultado = 'Eliminado';
        isMostrar = false;
    }
