describe("Escenario  21, Ingresar a la aplicacion, si el usuario no existe se crea. Se dirige al modulo Member. Crear un member y validar que aparezca en la lista de members, sale de la aplicacion.", () => {
  ...
  it(`Escenario 2 Crear un member con campos vacios`, () => {
    ...
    cy.screenshot(`Escenario 2 Prueba Negativa Crear un member con campos vacios`);
    pageMenuLeftAplicacion.clicAvatar(cy)
    pageMenuLeftAplicacion.clicSignOut(cy)
  });
  ...
  it(`Escenario 3 Crear un member con subscribe inactivo sin datos (nombre, email.label y note)`, () => {
    ...
    cy.screenshot(`Escenario 3 Prueba Negativa Crear un member con subscribe inactivo sin datos (nombre, email.label y note)`);
    pageMenuLeftAplicacion.clicAvatar(cy)
    pageMenuLeftAplicacion.clicSignOut(cy)
  });
  ...
  it(`Escenario 4 Crear un member con registro en campo name, Subscribe inactivo, email vacío`, () => {
    ...
    cy.screenshot(`Escenario 4 Prueba Negativa Crear un member con registro en campo name Subscribe inactivo email vacío`);
    pageMenuLeftAplicacion.clicAvatar(cy)
    pageMenuLeftAplicacion.clicSignOut(cy)
  });
  ...
  it(`Escenario 5 Crear un member con registro en campo label y Subscribe inactivo, email vacío`, () => {
    ...
    cy.screenshot(`Escenario 5 Prueba Negativa Crear un member con registro en campo label y Subscribe inactivo email vacío`);
    pageMenuLeftAplicacion.clicAvatar(cy)
    pageMenuLeftAplicacion.clicSignOut(cy)
  });
  ...
  it(`Escenario 6 Crear un member con registro en campo note y Subscribe inactivo, email vacío`, () => {
    ...
    cy.screenshot(`Escenario 6 Prueba Negativa Crear un member con registro en campo note y Subscribe inactivo email vacío`);
        pageMenuLeftAplicacion.clicAvatar(cy)
    pageMenuLeftAplicacion.clicSignOut(cy)
  });
  ...
  it(`Escenario 7 Crear un member con registro en campo name, label y Subscribe inactivo, note vacio, email vacío`, () => {
    ...
    cy.screenshot(`Escenario 7 Prueba Negativa Crear un member con registro en campo name label y Subscribe inactivo note vacio email vacío`);
        pageMenuLeftAplicacion.clicAvatar(cy)
    pageMenuLeftAplicacion.clicSignOut(cy)
  });
  ...
  it(`Escenario 8 Crear un member con registro en campo label,note y Subscribe inactivo, name vacio, email vacío`, () => {
    ...
    cy.screenshot(`Escenario 8 Prueba Negativa Crear un member con registro en campo name label note y Subscribe inactivo name vacio email vacío`);
        pageMenuLeftAplicacion.clicAvatar(cy)
    pageMenuLeftAplicacion.clicSignOut(cy)
  });
  ...
  it(`Escenario 9 Crear un member con registro en campo name,note y Subscribe inactivo, label vacio, email vacío`, () => {
    ...
    cy.screenshot(`Escenario 9 Prueba Negativa Crear un member con registro en campo name note y Subscribe inactivo label vacio email vacío`);
        pageMenuLeftAplicacion.clicAvatar(cy)
    pageMenuLeftAplicacion.clicSignOut(cy)
  });
  ...
  it(`Escenario 10 Crear un member con registro en campo name(incorrecto),label, note y Subscribe inactivo, email vacío`, () => {
    ...
    cy.screenshot(`Escenario 10 Prueba Negativa Crear un member con registro en campo name(incorrecto)label note y Subscribe inactivo email vacío`);
        pageMenuLeftAplicacion.clicAvatar(cy)
    pageMenuLeftAplicacion.clicSignOut(cy)
  });
  ...
  it(`Escenario 11 Crear un member con registro solamente en campo name y Subscribe inactivo`, () => {
    ...
    cy.screenshot(`Escenario 11 Prueba Negativa Crear un member con registro en campo  name y Subscribe inactivo`);
        pageMenuLeftAplicacion.clicAvatar(cy)
    pageMenuLeftAplicacion.clicSignOut(cy)
  });
  ...
  it(`Escenario 12 Crear un member con registro solamente en campo label y Subscribe inactivo`, () => {
    ...
    cy.screenshot(`Escenario 12 Prueba Negativa Crear un member con registro en campo  label y Subscribe inactivo`);
        pageMenuLeftAplicacion.clicAvatar(cy)
    pageMenuLeftAplicacion.clicSignOut(cy)
  });
  ...
  it(`Escenario 13 Crear un member con registro solamente en campo note y Subscribe inactivo`, () => {
    ...
    cy.screenshot(`Escenario 13 Prueba Negativa Crear un member con registro en campo  note y Subscribe inactivo`);
        pageMenuLeftAplicacion.clicAvatar(cy)
    pageMenuLeftAplicacion.clicSignOut(cy)
  });
  ...
  it(`Escenario 14 Crear un member con registro en campos name, label y Subscribe inactivo`, () => {
    ...
    cy.screenshot(`Escenario 14 Prueba Negativa Crear un member con registro en name label y Subscribe inactivo`);
        pageMenuLeftAplicacion.clicAvatar(cy)
    pageMenuLeftAplicacion.clicSignOut(cy)
  });
  ...
  it(`Escenario 15 Crear un member con registro en campos label,note y Subscribe inactivo`, () => {
    ...
    cy.screenshot(`Escenario 15 Prueba Negativa Crear un member con registro en campo label note y Subscribe inactivo`);
        pageMenuLeftAplicacion.clicAvatar(cy)
    pageMenuLeftAplicacion.clicSignOut(cy)
  });
  ...
  it(`Escenario 16 Crear un member con registro en campos name,note y Subscribe inactivo`, () => {
    ...
    cy.screenshot(`Escenario 16 Prueba Negativa Crear un member con registro en campo  name note y Subscribe inactivo`);
        pageMenuLeftAplicacion.clicAvatar(cy)
    pageMenuLeftAplicacion.clicSignOut(cy)
  });
  ...
  it(`Escenario 17 Crear un member con registro en campos name,note,label y Subscribe inactivo`, () => {
    ...
    cy.screenshot(`Escenario 17 Prueba Negativa Crear un member con registro en campo  name note label y Subscribe inactivo`);
        pageMenuLeftAplicacion.clicAvatar(cy)
    pageMenuLeftAplicacion.clicSignOut(cy)
  });
  ...
  it(`Escenario 18 Crear un member con registro en mail (datos incorrectos) y Subscribe activo demás datos vacíos`, () => {
    ...
    cy.screenshot(`Escenario 18 Prueba Negativa Crear un member con registro en mail (datos incorrectos) y Subscribe activo demás datos vacíos`);
        pageMenuLeftAplicacion.clicAvatar(cy)
    pageMenuLeftAplicacion.clicSignOut(cy)
  });
  ...
  it(`Escenario 19 Crear un member con registro en name, mail (datos incorrectos) y Subscribe activo`, () => {
    ...
    cy.screenshot(`Escenario 19 Prueba Negativa Crear un member con registro en name mail (datos incorrectos) y Subscribe activo`);
        pageMenuLeftAplicacion.clicAvatar(cy)
    pageMenuLeftAplicacion.clicSignOut(cy)
  });
  ...
  it(`Escenario 20 Crear un member con registro en label, mail (datos incorrectos) y Subscribe activo`, () => {
    ...
    cy.screenshot(`Escenario 20 Prueba Negativa Crear un member con registro en label mail (datos incorrectos) y Subscribe activo`);
        pageMenuLeftAplicacion.clicAvatar(cy)
    pageMenuLeftAplicacion.clicSignOut(cy)
  });
  ...
  it(`Escenario 21 Crear un member con registro en note, mail (datos incorrectos) y Subscribe activo`, () => {
    ...
    cy.screenshot(`Escenario 21 Prueba Negativa Crear un member con registro en note mail (datos incorrectos) y Subscribe activo`);
        pageMenuLeftAplicacion.clicAvatar(cy)
    pageMenuLeftAplicacion.clicSignOut(cy)
  });
  ...
  it(`Escenario 22  Crear un member con registro en name, label, mail (datos incorrectos) y Subscribe activo`, () => {
    ...
    cy.screenshot(`Escenario 22 Prueba Negativa Crear un member con registro en name label mail (datos incorrectos) y Subscribe activo`);
        pageMenuLeftAplicacion.clicAvatar(cy)
    pageMenuLeftAplicacion.clicSignOut(cy)
  });
  ...
  it(`Escenario 23 Crear un member con registro en label, mail (datos incorrectos) y Subscribe activo`, () => {
    ...
    cy.screenshot(`Escenario 23 Prueba Negativa Crear un member con registro en label mail (datos incorrectos) y Subscribe activo`);
        pageMenuLeftAplicacion.clicAvatar(cy)
    pageMenuLeftAplicacion.clicSignOut(cy)
  });
  ...
  it(`Escenario 24  Crear un member con registro en name, mail (datos incorrectos) y Subscribe activo`, () => {
    ...
    cy.screenshot(`Escenario 24 Prueba Negativa Crear un member con registro en name mail (datos incorrectos) y Subscribe activo`);
        pageMenuLeftAplicacion.clicAvatar(cy)
    pageMenuLeftAplicacion.clicSignOut(cy)
  });
  ...
  it(`Escenario 25 Crear un member con registro en name,label, mail (datos incorrectos) y Subscribe activo`, () => {
    ...
    cy.screenshot(`ISSUE Escenario 25 Prueba Negativa  Crear un member con registro en name label  mail (datos incorrectos) y Subscribe activo`);
        pageMenuLeftAplicacion.clicAvatar(cy)
    pageMenuLeftAplicacion.clicSignOut(cy)
  });
  ...
  it(`Escenario 26  Crear un member con registro en mail (datos incorrectos) y Subscribe activo`, () => {
    ...
    cy.screenshot(`Escenario 26 Prueba Negativa Crear un member con registro en mail (datos incorrectos) y Subscribe activo`);
        pageMenuLeftAplicacion.clicAvatar(cy)
    pageMenuLeftAplicacion.clicSignOut(cy)
  });
  ...
  it(`Escenario 27 Crear un member con registro en name, mail (datos incorrectos) y Subscribe activo`, () => {
    ...
    cy.screenshot(`ISSUE Escenario 27 Prueba Negativa Crear un member con registro en name mail (datos incorrectos) y Subscribe activo`);
        pageMenuLeftAplicacion.clicAvatar(cy)
    pageMenuLeftAplicacion.clicSignOut(cy)
  });
  ...
  it(`Escenario 28  Crear un member con registro en label, mail (datos incorrectos) y Subscribe activo`, () => {
    ...
    cy.screenshot(`Escenario 28 Prueba Negativa Crear un member con registro en label mail (datos incorrectos) y Subscribe activo`);
        pageMenuLeftAplicacion.clicAvatar(cy)
    pageMenuLeftAplicacion.clicSignOut(cy)
  });
  ...
  it(`Escenario 29 Crear un member con registro en note, mail (datos incorrectos) y Subscribe activo`, () => {
    ...
    cy.screenshot(`ISSUE Escenario 29 Prueba Negativa Crear un member con registro en note mail (datos incorrectos) y Subscribe activo`);
        pageMenuLeftAplicacion.clicAvatar(cy)
    pageMenuLeftAplicacion.clicSignOut(cy)
  });
  ...
  it(`Escenario 30 Crear un member con registro en name,label mail (datos incorrectos) y Subscribe activo`, () => {
    ...
    cy.screenshot(`Escenario 30 Prueba Negativa Crear un member con registro en name label mail (datos incorrectos) y Subscribe activo`);
        pageMenuLeftAplicacion.clicAvatar(cy)
    pageMenuLeftAplicacion.clicSignOut(cy)
  });
  ...
  it(`Escenario 31 Crear un member con registro en label,note mail (datos incorrectos) y Subscribe activo`, () => {
    ...
    cy.screenshot(`Escenario 31 Prueba Negativa Crear un member con registro en label note mail (datos incorrectos) y Subscribe activo`);
        pageMenuLeftAplicacion.clicAvatar(cy)
    pageMenuLeftAplicacion.clicSignOut(cy)
  });
  ...
  it(`Escenario 32 Crear un member con registro en name,note mail (datos incorrectos) y Subscribe activo`, () => {
    ...
    cy.screenshot(`Escenario 32 Prueba Negativa Crear un member con registro en name note mail (datos incorrectos) y Subscribe activo`);
        pageMenuLeftAplicacion.clicAvatar(cy)
    pageMenuLeftAplicacion.clicSignOut(cy)
  });
  ...
  it(`Escenario 33 Crear un member con registro en name,label, note mail (datos incorrectos) y Subscribe activo`, () => {
    ...
    cy.screenshot(`ISSUE Escenario 33 Prueba Negativa Crear un member con registro en name label note mail (datos incorrectos) y Subscribe activo`);
        pageMenuLeftAplicacion.clicAvatar(cy)
    pageMenuLeftAplicacion.clicSignOut(cy)
  });
  ...
  it(`Escenario 34 Crear un member con registro en name limite a 191 caracteres`, () => {
    ...
    memberAplicacion.memberAplicacion(cy);
    memberAplicacion.memberAplicacionCrear(cy, name.substring(0,191), mail, note,label,isSubscribe)
    cy.screenshot(`Escenario 34 Prueba Negativa Crear un member con registro en name limite a 191 caracteres`);
        pageMenuLeftAplicacion.clicAvatar(cy)
    pageMenuLeftAplicacion.clicSignOut(cy)
  });
    ...
    isSubscribe= faker.random.boolean();
    memberAplicacion.memberAplicacion(cy);
    memberAplicacion.memberAplicacionCrear(cy, name.substring(0,192), mail, note,label,isSubscribe)
    cy.screenshot(`Escenario 35 Prueba Negativa Crear un member con registro en name limite a 192 caracteres`);
        pageMenuLeftAplicacion.clicAvatar(cy)
    pageMenuLeftAplicacion.clicSignOut(cy)
  });
  ...
  it(`Escenario 36 Crear un member con un registro en note limite a 500 caracteres`, () => {
    ...
    isSubscribe= faker.random.boolean();
    memberAplicacion.memberAplicacion(cy);
    memberAplicacion.memberAplicacionCrear(cy, name, mail, note.substring(0,500),label,isSubscribe)
    cy.screenshot(`Escenario 36 Prueba Negativa Crear un member con registro en note limite a 500 caracteres`);
        pageMenuLeftAplicacion.clicAvatar(cy)
    pageMenuLeftAplicacion.clicSignOut(cy)
  });
    ...
    isSubscribe= faker.random.boolean();
    memberAplicacion.memberAplicacion(cy);
    memberAplicacion.memberAplicacionCrear(cy, name, mail, note.substring(0,501),label,isSubscribe)
    cy.screenshot(`Escenario 37 Prueba Negativa Crear un member con registro en note limite mayor a 501 caracteres`);
        pageMenuLeftAplicacion.clicAvatar(cy)
    pageMenuLeftAplicacion.clicSignOut(cy)
  });
  ...
  it(`Escenario 38 Crear un member con un registro en note limite a 500 caracteres y name limite a 191 caracteres`, () => {
    ...
    isSubscribe= faker.random.boolean();
    memberAplicacion.memberAplicacion(cy);
    memberAplicacion.memberAplicacionCrear(cy, name.substring(0,191), mail, note.substring(0,500),label,isSubscribe)
    cy.screenshot(`Escenario 38 Prueba Negativa Crear un member con registro en note limite  a 500 caracteres y name limite a 191 caracteres`);
        pageMenuLeftAplicacion.clicAvatar(cy)
    pageMenuLeftAplicacion.clicSignOut(cy)
  });
  ...
  it(`Escenario 39 Crear un member con un registro en note mayor a 500 caracteres y name mayor a 191 caracteres`, () => {
    ...
    isSubscribe= faker.random.boolean();
    memberAplicacion.memberAplicacion(cy);
    memberAplicacion.memberAplicacionCrear(cy, name.substring(0,192), mail, note.substring(0,501),label,isSubscribe)
    cy.screenshot(`Escenario 39 Prueba Negativa Crear un member con registro en note mayor  a 500 caracteres y name mayor a 191 caracteres`);
        pageMenuLeftAplicacion.clicAvatar(cy)
    pageMenuLeftAplicacion.clicSignOut(cy)
  });
  ...
  it(`Escenario 40 Crear un member con un registro en mail limite a 64 caracteres o números con dominio válido`, () => {
    ...
    isSubscribe= faker.random.boolean();
    memberAplicacion.memberAplicacion(cy);
    memberAplicacion.memberAplicacionCrear(cy, name.substring(0,191), short_email.concat('@dominio.com'), note,label,isSubscribe)
    cy.screenshot(`Escenario 40 Prueba Negativa Crear un member con registro en mail mayor a 64 caracteres o números con dominio válido`);
        pageMenuLeftAplicacion.clicAvatar(cy)
    pageMenuLeftAplicacion.clicSignOut(cy)
  });
  ...
  it(`Escenario 40 Crear un member con un registro en mail mayor a 64 caracteres o números con dominio válido`, () => {
    ...
    memberAplicacion.memberAplicacion(cy);
    memberAplicacion.memberAplicacionCrear(cy, name.substring(0,191), short_email.concat('@dominio.com'), note,label,isSubscribe)
    cy.screenshot(`ISSUE Escenario 40 Prueba Negativa Crear un member con registro en mail mayor a 64 caracteres o números con dominio válido`);
        pageMenuLeftAplicacion.clicAvatar(cy)
    pageMenuLeftAplicacion.clicSignOut(cy)
  });
  ...
  // ISSUE
  it(`Escenario 41 Crear un member con un registro en mail limite a 191 caracteres o números con dominio válido`, () => {
    ...
    memberAplicacion.memberAplicacion(cy);
    memberAplicacion.memberAplicacionCrear(cy, name.substring(0,191), short_email.concat('@dominio.com'), note,label,isSubscribe)
    cy.screenshot(`ISSUE Escenario 41 Prueba Negativa Crear un member con registro en mail limite a 191 caracteres o números con dominio válido`);
        pageMenuLeftAplicacion.clicAvatar(cy)
    pageMenuLeftAplicacion.clicSignOut(cy)
  });


  it(`Escenario 42 Crear un member con un registro en mail mayor a 191 caracteres o números con dominio válido`, () => {
    ...
    memberAplicacion.memberAplicacion(cy);
    memberAplicacion.memberAplicacionCrear(cy, name.substring(0,191), short_email.concat('@dominio.com'), note,label,isSubscribe)
    cy.screenshot(`Escenario 42 Prueba Negativa Crear un member con registro en mail mayor a 191 caracteres o números con dominio válido`);
        pageMenuLeftAplicacion.clicAvatar(cy)
    pageMenuLeftAplicacion.clicSignOut(cy)
  });
  ...
  it("Escenario 44 Eliminar un member ", () => {
    if (Cypress.env("isRegresionVisual") != true) {
      mail = faker.internet.email();
      name = faker.name.findName();
      note = faker.company.bs();
    ...
    memberAplicacion.memberAplicacionEliminar(cy);
    cy.screenshot(`Escenario 44 Prueba Positiva Eliminar`);
  ...
  it("Escenario 45 Modificar  un member", () => {
    if (Cypress.env("isRegresionVisual") != true) {
      mail = faker.internet.email();
      name = faker.name.findName();
      note = faker.company.bs();
    ...
    cy.screenshot(`Escenario 45 Prueba Positiva modificar member`);
  ...
  it("Escenario 46 crear un member unsubscribe", () => {
    if (Cypress.env("isRegresionVisual") != true) {
      mail = faker.internet.email();
      name = faker.name.findName();
      note = faker.company.bs();
    ...
    cy.screenshot(`Escenario 46 Prueba Positiva crear  member unsubscribe`);
    memberAplicacion.memberAplicacion(cy);
    memberAplicacion.memberAplicacionBuscar(cy, mail, true);
    memberAplicacion.memberAplicacion(cy);
    memberAplicacion.memberAplicacionEliminar(cy);
